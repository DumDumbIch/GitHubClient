...
import com.dumdumbich.sketchbook.githubclient.ui.pages.repository.RepositoryFragment
...
class AndroidScreens : IScreens {
    ...
    override fun repository(repository: GitHubRepository) = FragmentScreen { RepositoryFragment.newInstance(repository) }
}